            ...
            <div class="container">
                <div class="header p-t-20">
                    ...
                    <div class="row header-banner align-items-center">
                        ...
                        {{-- ========== HERO IMAGE START ========== --}}
                        <div id="hero-image" class="col-lg-6 offset-lg-2 text-right carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="img-shadow img-fluid" src="{{ asset("assets/images/misi.jpeg") }}" alt="Sekolah MTsN 1 Labuhanbatu">
                                </div>
