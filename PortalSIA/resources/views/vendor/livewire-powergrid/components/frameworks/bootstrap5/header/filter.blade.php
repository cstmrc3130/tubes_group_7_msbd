<div class="col-12 justify-content-end text-right pr-0" >
    <label class="col-12 col-sm-8 align-self-end mb-0 text-right pr-0">
        @if(data_get($setUp, 'header.searchInput'))
            <div class="input-group w-100 justify-content-end pr-0">
