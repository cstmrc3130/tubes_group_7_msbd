<div class="page-wrapper">
    ...
    <div class="container-fluid" style="min-height: 74vh">
        <div class="col-4 col-sm-2 d-flex justify-content-start mb-3">
            <button class="btn btn-block btn-info" data-toggle='modal' data-target="#exampleModal" @if(session('currentSchoolYear') != \App\Models\SchoolYear::query()->where('semester', 'Ganjil')->orderBy('year', 'desc')->value('id')) @disabled(true) @endif>
