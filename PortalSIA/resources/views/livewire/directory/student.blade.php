<div class="container">
    ...
    <div class="row header-banner align-items-center pt-3 pb-0">
        ...
        <div class="col-sm-12 col-md-6 col-lg-4">
            <form wire:submit.prevent="Search">
                <div class="input-group mb-3">
                    <input type="text" class="form-control @error('keyword') is-invalid @enderror" placeholder="Masukkan NISN atau Nama" aria-label="" aria-describedby="basic-addon1" wire:model.defer="keyword">
        ...
        @if(session()->has('paginatedStudent'))
        ...
        <div class="col-lg-8 col-md-6 col-sm-12">
            <div class="alert {{ $totalUserFound != 0 ? 'alert-success' : 'alert-danger' }} " >
                ...
                <span>
                    {{ "Found " . $totalUserFound . ($totalUserFound <= 1 ? ' student' : ' students') . " with keyword " . "'" . $keyword . "'" }}
                </span> 
    ...
    <div class="row header-banner align-items-center pt-3">
        ...
        @forelse ($paginatedStudent as $student)
            ...
            <div class="card border-dark">
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <img src="{{ $student->user->profile_picture != "DEFAULT" ? asset('users-profile-pictures/' . $student->user->profile_picture) : asset('users-profile-pictures/' . 'default-user.svg') }}" class="img-fluid w-2" alt="friend" width="84" length="84">
                        <h5 class="mt-3">{{ $student->name }}<i class="mdi mdi-checkbox-marked-circle-outline text-success ml-1"></i></h5>
                        <p class="mb-0 text-muted"><i class="mdi mdi-email-outline me-1"></i>{{ $student->user->email }}</p>
                        ...
                        <div class="row mt-3 justify-content-center">
                            <div class="col-12">
                                <a href="#" data-toggle="modal" data-target="#exampleModal" class="btn w-100 btn-outline-dark" wire:click="ShowDetails({{ $student->NISN }})">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    {{ Form::text('NISN', $NISN, ['class' => 'form-control form-control-line bg-transparent', 'disabled', 'readonly']) }}
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    {{ Form::text('entry-year', $entryYear, ['class' => 'form-control form-control-line bg-transparent', 'disabled', 'readonly']) }}
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    {{ Form::text('status', $status, ['class' => 'form-control form-control-line bg-transparent', 'disabled', 'readonly']) }}
                                </div>
                            </div>
