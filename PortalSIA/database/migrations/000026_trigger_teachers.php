...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        // trigger insert
        DB::unprepared(
            'CREATE TRIGGER insert_teachers AFTER INSERT ON teachers
            FOR EACH ROW BEGIN
        ...
        // trigger update
        DB::unprepared(
            'CREATE TRIGGER update_teachers BEFORE UPDATE ON teachers
            FOR EACH ROW BEGIN
    ...
    public function down()
    {
        ...
        DB::unprepared('DROP TRIGGER insert_teachers');
        DB::unprepared('DROP TRIGGER update_teachers');
    }
};
